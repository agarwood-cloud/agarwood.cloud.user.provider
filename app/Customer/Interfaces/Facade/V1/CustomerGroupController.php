...
class CustomerGroupController extends AbstractBaseController
{
    ...
    public function actionIndex(Request $request): ?Response
    {
        ...
        return $this->wrapper()->setData(
            $this->application->indexProvider($this->getServiceUuid(''), $dto)
        )->response();
    }
    ...
    public function actionCreate(Request $request, Response $response): ?Response
    {
        ...
        return $this->wrapper()->setData(
            $this->application->createProvider($this->getServiceUuid(''), $DTO)
     ...
     * @RequestMapping(route="customer-group/{uuid}", method={RequestMethod::PUT, RequestMethod::PATCH})
     */
    public function actionUpdate(Request $request, string $uuid): ?Response
    {
        $DTO = CustomerGroupAssembler::attributesToUpdateDTO((array)$request->getParsedBody());
        return $this->wrapper()->setData(
            $this->application->updateProvider($uuid, $DTO)
        )->response();
    }
     ...
     * 删除客服分组信息
     *
     * @RequestMapping(route="customer-group/{uuids}", method={ RequestMethod::DELETE},params={"uuids"="[A-Za-z0-9_,-]+"})
     * @param string   $uuids
     * @param Response $response
     *
     * @return Response|null
     ...
     * 查看客服分组详情
     *
     * @RequestMapping(route="customer-group/{uuid}", method={RequestMethod::GET},params={"uuid"="[A-Za-z0-9_-]+"})
     * @param string $uuid
     *
     * @return Response|null
     */
